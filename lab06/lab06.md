...
3. Значение в поле Length (Длина) – это длина чего?
   - Это длина пейлоада + заголовков ($71 = 63 + 4 * 2$)
4. Какое максимальное количество байт может быть включено в полезную нагрузку UDP-пакета?
   - $65535 - 20 - 8 = 65507$ ($65535$ - макс. размер ipv4 пакета, $20$ - длина заголовка ip пакета, $8$ - длина заголовка udp)
5. Чему равно максимально возможное значение номера порта отправителя?
   - $2^{16} - 1 = 65535$, т.к. порт занимает 16 бит
...
7. Проверьте UDP-пакет и ответный UDP-пакет, отправляемый вашим хостом. Определите
   ...
   - У отправленного пакета Src Port: $49271$, Dst Port: $53$. В ответном пакете, логично, наоборот. 
...
#### Скрины
<img src="images/testuser.png" width=1080 />
<img src="images/create_folder.png" width=300 />
