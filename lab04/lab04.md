...
#### Демонстрация работы
<img src="images/taskA.png" width=1080/>
...
#### Демонстрация работы
<img src="images/taskB.png" width=1080/>
...
#### Демонстрация работы
<img src="images/taskC.png" width=1080/>
...
3. Используя nslookup, найдите веб-сервер, имеющий несколько IP-адресов. Сколько IP-адресов имеет веб-сервер вашего учебного заведения?
   <img src="images/nslookup31.png" width=1080/>
   <img src="images/nslookup32.png" width=1080/>
...
1. Найдите DNS-запрос и ответ на него. С использованием какого транспортного протокола
   они отправлены?
   - UDP
   <img src="images/ietf1.png" width=1080/>
...
3. На какой IP-адрес отправлен DNS-запрос? Используйте ipconfig для определения IP-адреса
   ...
   - 192.168.0.1
   - Да, одинаковы
   <img src="images/ietf2.png" width=1080/>
...
5. Проанализируйте ответное сообщение DNS. Сколько в нем «ответов»? Что содержится в
   каждом?
   - 2
   - ip-адреса (ipv4 в A и ipv6 в AAAA)
   <img src="images/ietf3.png" width=1080/>
...
4. Проанализируйте ответное сообщение DNS. Сколько в нем «ответов»? Что содержится в каждом?
   - В ответе на последний запрос DNS "ответов" нет, только Authorative nameserver: ns.pu.ru
   <img src="images/spbu2.png" width=1080/>
   - В ответе же на прошлый запрос "ответов" два: cname spbu.ru и ip 195.70.219.100    
   <img src="images/spbu3.png" width=1080/>
...
1. На какой IP-адрес отправлен DNS-запрос? Совпадает ли он с адресом локального DNS-сервера, установленного по умолчанию?
   - 192.168.0.1
   - Да, как и в двух предыдущих заданиях
   <img src="images/spbuns1.png" width=1080/>
...
3. Проанализируйте ответное сообщение DNS. Имена каких DNS-серверов университета в
   ...
   - Есть адрес ns7.spbu.ru: 185.44.15.195
   <img src="images/spbuns2.png" width=1080/>
...
1. На какой IP-адрес отправлен DNS-запрос? Совпадает ли он с адресом локального DNS-сервера, установленного по умолчанию? 
   ...
   - 195.70.196.210, с локальным не совпадает
   <img src="images/spbuns3.png" width=1080/>
   - Он принадлежит хосту ns2.pu.ru, перед этим был DNS-запрос на резолвинг этого хоста
   <img src="images/spbuns4.png" width=1080/>
2. Проанализируйте сообщение-запрос DNS. Запись какого типа запрашивается? Содержатся
   ли в запросе какие-нибудь «ответы»?
   - Есть два запроса: A и AAAA
   - "ответов" в них не содержится
3. Проанализируйте ответное сообщение DNS. Сколько в нем «ответов»? Что содержится в
   каждом?
   - 2 в A, 0 в AAAA
   <img src="images/spbuns5.png" width=1080/>
   - cname и ip в A, Authorative nameserver в AAAA
   <img src="images/spbuns6.png" width=1080/>

### Е. Сервисы whois (2 балла)
1. Что такое база данных whois?
   - База регистрационныох данных о владельцах доменных имён, IP-адресов и автономных систем, использующая whois-интерфейс (сетевой протокол прикладного уровня)
2. Используя различные сервисы whois в Интернете, получите имена любых двух DNS-серверов. 
   ...
   - www.whois.com/whois
   <img src="images/whois1.png" width=1080/>
   - www.nic.ru/whois
   <img src="images/whois2.png" width=1080/>
3. Используйте команду nslookup на локальном хосте, чтобы послать запросы трем конкретным
   ...
   <img src="images/whois3.png" width=1080/>
